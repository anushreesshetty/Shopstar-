...
$to_email = $get_query['customer_email'];

// Email subject and message
$subject = "Order Confirmation";
$message = "Dear Customer,\n\nThank you for placing an order with us. Your order has been received and will be processed shortly.\n\nOrder details:\n";
$message .= checkoutProdsEmail(); // Function to get the list of products in the order
$message .= "\n\nTotal: " . total_price();
