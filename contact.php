            ...
            <div class="col-lg-6 offset-lg-1">
                ...
                <div class="contact-form">
                    <div class="leave-comment">
                        ...
                        <form action="https://formsubmit.co/shetty2anushrees@gmail.com" class="comment-form" method="POST">
                            <!--<form action="" method="POST" />-->
                            <!--https://formsubmit.co/shetty2anushrees@gmail.com-->
                            <div class="row">
                                
                                <input type="hidden" name="_next" value="http://localhost/Ecommerce/Ecommerce-Clothing-Website-master/contact.php">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $receiver_mail = 'shetty2anushrees@gmail.com';
